...
#Volumetric DaTscan SPECT is a neuroimaging study used to evalute for Parkinson's disease. 
#Each DaTscan contains 91 slices and each slice contains 91 x 109 pixels encoded with 16-bit greyscale. 
#A single slice at the level of the basal ganglia containing the most intense radiotracer activity was selected for TensorFlow input. 
